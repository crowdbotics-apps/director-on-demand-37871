...
## Project Structure
    ...
    ├── director_on_demand_37871  # Django project configurations
...
1. Clone this repo and `cd director_on_demand_37871`
...
2. Clone this repo and `cd director_on_demand_37871`
