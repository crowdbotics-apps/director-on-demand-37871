  ...
  return <ScrollView style={styles.container}>
      ...
      <View style={styles.chooseContainer}>
        <View style={styles.sectionContainer}>
          ...
          <View style={[styles.checkboxContainer, styles.jtpjcvQt]}>
      ...
      <View style={styles.dateTimeContainer}>
        ...
        <Text style={[styles.mr10, styles.sYSAayIu]}>Starting time</Text>
      </View>
      <View style={[styles.chooseContainer, styles.sHMfLrLi]}>
        <Text></Text>
        <Text>09:00 AM</Text>
      </View>
