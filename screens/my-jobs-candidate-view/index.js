  ...
  return <ScrollView style={styles.container}>
      ...
      <View style={styles.chooseContainer}>
        <View style={styles.sectionContainer}>
          ...
          <View style={[styles.checkboxContainer, styles.PJpmKtpi]}>
      ...
      <View style={styles.dateTimeContainer}>
        ...
        <Text style={[styles.mr10, styles.NzjwjCTX]}>Starting time</Text>
      </View>
      <View style={[styles.chooseContainer, styles.pNtnpdGt]}>
        <Text></Text>
        <Text>09:00 AM</Text>
      </View>
