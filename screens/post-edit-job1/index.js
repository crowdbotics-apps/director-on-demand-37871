...
const PostEditJobScreen = params => {
  return <ScrollView style={styles.container}>
      ...
      <View style={[styles.textInput, styles.TQcyvRJf]}>
      ...
      <View style={styles.sliderTextContainer}>
        ...
        <Text style={[styles.sliderText, styles.KRktyeOR]}>$80k</Text>
      </View>
      ...
      <View style={styles.sectionContainer}>
        <View style={styles.checkboxContainer}>
          <Image source={require( // @ts-ignore
        "./assets/checkbox.png")} style={styles.checkbox} />
          <Text style={styles.label}>Basic</Text>
        </View>
        <View style={styles.checkboxContainer}>
          <Image source={require( // @ts-ignore
        "./assets/box.png")} style={styles.checkbox} />
